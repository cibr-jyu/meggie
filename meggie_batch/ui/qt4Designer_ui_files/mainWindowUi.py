...
#
# Created: Sun Oct 12 22:24:11 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBoxRestOfSourcePreparation.setGeometry(QtCore.QRect(9, 9, 416, 336))
        ...
        self.frame_3 = QtGui.QFrame(self.tabForwardModel)
        self.frame_3.setGeometry(QtCore.QRect(431, 9, 541, 341))
        self.frame_3.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_3.setObjectName(_fromUtf8("frame_3"))
        self.groupBox_3 = QtGui.QGroupBox(self.frame_3)
        self.groupBox_3.setGeometry(QtCore.QRect(11, 35, 391, 221))
        self.groupBox_3.setObjectName(_fromUtf8("groupBox_3"))
        self.label_7 = QtGui.QLabel(self.frame_3)
        self.label_7.setGeometry(QtCore.QRect(11, 11, 316, 18))
        ...
        self.frame_4 = QtGui.QFrame(self.tabCoregistration)
        ...
        self.frame_5 = QtGui.QFrame(self.tabCoregistration)
        ...
        self.labelCurrentCoregistrationParameters = QtGui.QLabel(self.frame_5)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelCurrentCoregistrationParameters.setFont(font)
        self.labelCurrentCoregistrationParameters.setObjectName(_fromUtf8("labelCurrentCoregistrationParameters"))
        self.gridLayout_32.addWidget(self.labelCurrentCoregistrationParameters, 0, 0, 1, 1)
        self.label_12 = QtGui.QLabel(self.frame_5)
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.gridLayout_32.addWidget(self.label_12, 1, 0, 1, 1)
        self.verticalLayout_18.addWidget(self.frame_5)
        self.formLayout_5.setLayout(0, QtGui.QFormLayout.LabelRole, self.verticalLayout_18)
        self.plainTextEdit_2 = QtGui.QPlainTextEdit(self.tabCoregistration)
        self.plainTextEdit_2.setObjectName(_fromUtf8("plainTextEdit_2"))
        self.formLayout_5.setWidget(1, QtGui.QFormLayout.LabelRole, self.plainTextEdit_2)
        ...
        self.plainTextEdit_3 = QtGui.QPlainTextEdit(self.tabForwardSolution)
        self.plainTextEdit_3.setGeometry(QtCore.QRect(320, 280, 256, 192))
        ...
        self.plainTextEdit_5 = QtGui.QPlainTextEdit(self.tab)
...
" + mne_setup_forward_model)", None))
        ...
        self.label_7.setText(_translate("MainWindow", "Parameters of the selected forward model:", None))
        ...
        self.pushButtonMNECoregistration.setText(_translate("MainWindow", "Use MNE Coregistration", None))
        self.label_11.setText(_translate("MainWindow", "OR", None))
        self.PushButtonMNE_AnalyzeCoregistration.setText(_translate("MainWindow", "Use mne_analyze to coregister", None))
        self.labelCurrentCoregistrationParameters.setText(_translate("MainWindow", "Current coregistration parameters:", None))
        self.label_12.setText(_translate("MainWindow", "***parameter stuff here", None))
        self.plainTextEdit_2.setPlainText(_translate("MainWindow", "Tästä välilehdestä averaging-lehden kaltainen? Eli vasemmalle puolelle edellisestä välilehdestä sen tuottamat \"kokoelmat\", keskelle toiminnot, oikealle puolelle toimintojen tuottamat \"kokoelmat\"?", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabCoregistration), _translate("MainWindow", "Coregistration", None))
        self.plainTextEdit_3.setPlainText(_translate("MainWindow", "Tästäkin välilehdestä averaging-lehden kaltainen? Eli vasemmalle puolelle edellisestä välilehdestä sen tuottamat \"kokoelmat\", keskelle toiminnot, oikealle puolelle toimintojen tuottamat \"kokoelmat\"?", None))
