...
#
# Created: Tue Apr  7 03:36:02 2015
...
class Ui_DialogGroupTFR(object):
    def setupUi(self, DialogGroupTFR):
        ...
        DialogGroupTFR.setTabOrder(self.checkBoxSaveTopo, self.checkBoxSavePlot)
        ...
        DialogGroupTFR.setTabOrder(self.pushButtonModify, self.buttonBox)
