...
#
# Created: Thu Oct  2 15:24:35 2014
...
class Ui_DialogPreferences(object):
    def setupUi(self, DialogPreferences):
        ...
        DialogPreferences.resize(499, 319)
        self.formLayout = QtGui.QFormLayout(DialogPreferences)
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.SpanningRole, self.groupBoxWorkingDirectory)
        self.groupBoxEnv = QtGui.QGroupBox(DialogPreferences)
        self.groupBoxEnv.setObjectName(_fromUtf8("groupBoxEnv"))
        self.gridLayout_3 = QtGui.QGridLayout(self.groupBoxEnv)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.SpanningRole, self.groupBoxEnv)
