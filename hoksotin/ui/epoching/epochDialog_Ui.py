...
#
# Created: Wed May  8 16:34:59 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 280, 361, 113))
        self.layoutWidget1.setObjectName(_fromUtf8("layoutWidget1"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.layoutWidget1)
        self.verticalLayout_2.setMargin(0)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.labelExclude = QtGui.QLabel(self.layoutWidget1)
        self.labelExclude.setObjectName(_fromUtf8("labelExclude"))
        self.verticalLayout_2.addWidget(self.labelExclude)
        self.textEditExclude = QtGui.QTextEdit(self.layoutWidget1)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 400, 361, 105))
        self.layoutWidget2.setObjectName(_fromUtf8("layoutWidget2"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.layoutWidget2)
        self.verticalLayout_3.setMargin(0)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.labelRejections = QtGui.QLabel(self.layoutWidget2)
        ...
        self.labelGradReject_3 = QtGui.QLabel(self.layoutWidget2)
        ...
        self.doubleSpinBoxGradReject_3 = QtGui.QDoubleSpinBox(self.layoutWidget2)
        ...
        self.labelEegReject_3 = QtGui.QLabel(self.layoutWidget2)
        self.labelEegReject_3.setObjectName(_fromUtf8("labelEegReject_3"))
        self.horizontalLayout_32.addWidget(self.labelEegReject_3)
        self.doubleSpinBoxEEGReject_3 = QtGui.QDoubleSpinBox(self.layoutWidget2)
        ...
        self.labelMagReject_3 = QtGui.QLabel(self.layoutWidget2)
        self.labelMagReject_3.setObjectName(_fromUtf8("labelMagReject_3"))
        self.horizontalLayout_33.addWidget(self.labelMagReject_3)
        self.doubleSpinBoxMagReject_3 = QtGui.QDoubleSpinBox(self.layoutWidget2)
        ...
        self.labelEogReject_3 = QtGui.QLabel(self.layoutWidget2)
        self.labelEogReject_3.setObjectName(_fromUtf8("labelEogReject_3"))
        self.horizontalLayout_34.addWidget(self.labelEogReject_3)
        self.doubleSpinBoxEOGReject_3 = QtGui.QDoubleSpinBox(self.layoutWidget2)
