...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 687, 728))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 7, 593, 583))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 10, 235, 96))
        ...
        self.radioButtonPositionFile.setEnabled(True)
        ...
        self.pushButtonBrowsePositionFile.setEnabled(True)
        ...
        self.radioButtonPositionAverage.setEnabled(True)
        ...
        QtCore.QObject.connect(self.checkBoxTransform, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.frame_2.setEnabled)
