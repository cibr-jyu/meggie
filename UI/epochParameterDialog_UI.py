...
#
# Created: Thu Mar 21 09:48:43 2013
...
class Ui_ParameterDialog(object):
    def setupUi(self, ParameterDialog):
        ...
        ParameterDialog.resize(391, 360)
        self.cancelOkButtonBox = QtGui.QDialogButtonBox(ParameterDialog)
        self.cancelOkButtonBox.setGeometry(QtCore.QRect(20, 310, 176, 31))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(21, 11, 351, 62))
        self.layoutWidget.setObjectName(_fromUtf8("layoutWidget"))
        self.verticalLayout = QtGui.QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setMargin(0)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.labelEventFile = QtGui.QLabel(self.layoutWidget)
        ...
        self.layoutWidget1 = QtGui.QWidget(ParameterDialog)
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 80, 351, 227))
        ...
        self.lineEditEventID = QtGui.QLineEdit(self.layoutWidget1)
        ...
        self.lineEditTmin = QtGui.QLineEdit(self.layoutWidget1)
        ...
        self.lineEditTmax = QtGui.QLineEdit(self.layoutWidget1)
        ...
        self.labelReject = QtGui.QLabel(self.layoutWidget1)
        ...
        self.lineEditReject = QtGui.QLineEdit(self.layoutWidget1)
        ...
        self.checkBoxMeg = QtGui.QCheckBox(self.layoutWidget1)
        self.checkBoxMeg.setObjectName(_fromUtf8("checkBoxMeg"))
        self.horizontalLayout_6.addWidget(self.checkBoxMeg)
        self.checkBoxEeg = QtGui.QCheckBox(self.layoutWidget1)
        ...
        self.checkBoxEog = QtGui.QCheckBox(self.layoutWidget1)
    ...
    def retranslateUi(self, ParameterDialog):
        ...
        self.comboBoxStimulus.setItemText(0, _translate("ParameterDialog", "New Itemffdf", None))
