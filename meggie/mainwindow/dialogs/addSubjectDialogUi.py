# Form implementation generated from reading ui file './meggie/mainwindow/dialogs/addSubjectDialogUi.ui'
#
...
class Ui_AddSubject(object):
    def setupUi(self, AddSubject):
        ...
        self.labelAddSubjects = QtWidgets.QLabel(parent=AddSubject)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButtonCancel = QtWidgets.QPushButton(parent=AddSubject)
        self.pushButtonCancel.setObjectName("pushButtonCancel")
        self.horizontalLayout_2.addWidget(self.pushButtonCancel)
        self.pushButtonOk = QtWidgets.QPushButton(parent=AddSubject)
        self.pushButtonOk.setObjectName("pushButtonOk")
        self.horizontalLayout_2.addWidget(self.pushButtonOk)
        self.gridLayout.addLayout(self.horizontalLayout_2, 2, 0, 1, 3)
        self.scrollArea = QtWidgets.QScrollArea(parent=AddSubject)
        ...
        self.listWidgetFileNames = QtWidgets.QListWidget(
            parent=self.scrollAreaWidgetContents
        )
        ...
        self.pushButtonSample = QtWidgets.QPushButton(
            parent=self.scrollAreaWidgetContents
        )
