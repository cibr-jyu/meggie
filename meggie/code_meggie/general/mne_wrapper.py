...
make_watershed_bem = wrap('debug', mne.bem.make_watershed_bem)
setup_source_space = wrap('info', mne.setup_source_space)
make_bem_model = wrap('info', mne.make_bem_model)
make_bem_solution = wrap('info', mne.make_bem_solution)
make_forward_solution = wrap('info', mne.make_forward_solution)
read_forward_solution = wrap('info', mne.read_forward_solution)
write_forward_solution = wrap('info', mne.write_forward_solution)
