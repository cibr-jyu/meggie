# Form implementation generated from reading ui file './meggie/utilities/widgets/batchingWidgetUi.ui'
#
...
class Ui_BatchingWidget(object):
    def setupUi(self, BatchingWidget):
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=BatchingWidget)
        ...
        self.checkBoxBatch = QtWidgets.QCheckBox(parent=self.layoutWidget)
        ...
        self.functionalityWidget = QtWidgets.QWidget(parent=BatchingWidget)
        ...
        self.pushButtonApplyAll = QtWidgets.QPushButton(parent=self.functionalityWidget)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.functionalityWidget)
        ...
        self.labelSubjects = QtWidgets.QLabel(parent=self.functionalityWidget)
        ...
        self.listWidgetSubjects = QtWidgets.QListWidget(parent=self.functionalityWidget)
        ...
        self.checkBoxBatch.toggled["bool"].connect(BatchingWidget.showWidget)  # type: ignore
