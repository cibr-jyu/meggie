...
from meggie.utilities.dialogs.experimentInfoDialogUi import Ui_experimentInfoDialog
...
class ExperimentInfoDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.ui.textBrowserExperimentDescription.setText(
            parent.experiment.description)
