# Form implementation generated from reading ui file './meggie/utilities/dialogs/shortQuestionBoxUi.ui'
#
...
class Ui_shortQuestionBox(object):
    def setupUi(self, shortQuestionBox):
        ...
        self.pushButtonCancel = QtWidgets.QPushButton(parent=shortQuestionBox)
        self.pushButtonCancel.setObjectName("pushButtonCancel")
        self.gridLayout.addWidget(self.pushButtonCancel, 1, 1, 1, 1)
        self.pushButtonOk = QtWidgets.QPushButton(parent=shortQuestionBox)
        self.pushButtonOk.setObjectName("pushButtonOk")
        self.gridLayout.addWidget(self.pushButtonOk, 1, 2, 1, 1)
        self.scrollArea = QtWidgets.QScrollArea(parent=shortQuestionBox)
