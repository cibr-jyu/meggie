# Form implementation generated from reading ui file './meggie/actions/raw_ica/dialogs/icaDialogUi.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButtonApply = QtWidgets.QPushButton(parent=Dialog)
        ...
        self.groupBoxComputation = QtWidgets.QGroupBox(
        ...
        self.spinBoxMaxIter = QtWidgets.QSpinBox(parent=self.groupBoxComputation)
        self.spinBoxMaxIter.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.labelNComponents = QtWidgets.QLabel(parent=self.groupBoxComputation)
        ...
        self.doubleSpinBoxNComponents = QtWidgets.QDoubleSpinBox(
            parent=self.groupBoxComputation
        )
        ...
        self.labelMaxIter = QtWidgets.QLabel(parent=self.groupBoxComputation)
        ...
        self.pushButtonCompute = QtWidgets.QPushButton(parent=self.groupBoxComputation)
        ...
        self.groupBoxComponents = QtWidgets.QGroupBox(
            parent=self.scrollAreaWidgetContents
        )
        ...
        self.labelNotRemoved = QtWidgets.QLabel(parent=self.groupBoxComponents)
        self.labelNotRemoved.setObjectName("labelNotRemoved")
        self.gridLayout_2.addWidget(self.labelNotRemoved, 0, 0, 1, 1)
        self.listWidgetNotRemoved = QtWidgets.QListWidget(
            parent=self.groupBoxComponents
        )
        ...
        self.listWidgetRemoved = QtWidgets.QListWidget(parent=self.groupBoxComponents)
        self.listWidgetRemoved.setObjectName("listWidgetRemoved")
        self.gridLayout_2.addWidget(self.listWidgetRemoved, 4, 0, 1, 1)
        self.labelRemoved = QtWidgets.QLabel(parent=self.groupBoxComponents)
        self.labelRemoved.setObjectName("labelRemoved")
        self.gridLayout_2.addWidget(self.labelRemoved, 3, 0, 1, 1)
        self.pushButtonTransfer = QtWidgets.QPushButton(parent=self.groupBoxComponents)
        ...
        self.pushButtonPlotProperties = QtWidgets.QPushButton(
            parent=self.groupBoxComponents
        )
        ...
        self.pushButtonPlotChanges = QtWidgets.QPushButton(
            parent=self.groupBoxComponents
        )
        ...
        self.pushButtonPlotSources = QtWidgets.QPushButton(
            parent=self.groupBoxComponents
        )
        ...
        self.pushButtonPlotTopographies = QtWidgets.QPushButton(
            parent=self.groupBoxComponents
        )
