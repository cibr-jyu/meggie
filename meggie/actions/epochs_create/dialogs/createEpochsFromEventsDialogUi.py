# Form implementation generated from reading ui file './meggie/actions/epochs_create/dialogs/createEpochsFromEventsDialogUi.ui'
#
...
class Ui_CreateEpochsFromEventsDialog(object):
    def setupUi(self, CreateEpochsFromEventsDialog):
        ...
        CreateEpochsFromEventsDialog.setWindowModality(
        ...
        self.pushButtonCancel = QtWidgets.QPushButton(
            parent=CreateEpochsFromEventsDialog
        )
        self.pushButtonCancel.setObjectName("pushButtonCancel")
        self.horizontalLayout_10.addWidget(self.pushButtonCancel)
        self.pushButtonBatch = QtWidgets.QPushButton(
            parent=CreateEpochsFromEventsDialog
        )
        ...
        self.scrollArea = QtWidgets.QScrollArea(parent=CreateEpochsFromEventsDialog)
        ...
        self.groupBoxEventsList = QtWidgets.QGroupBox(
        ...
        self.listWidgetEvents = QtWidgets.QListWidget(parent=self.groupBoxEventsList)
        ...
        self.groupBoxRejection = QtWidgets.QGroupBox(
            parent=self.scrollAreaWidgetContents
        )
        ...
        self.checkBoxGrad = QtWidgets.QCheckBox(parent=self.groupBoxRejection)
        self.checkBoxGrad.setChecked(True)
        self.checkBoxGrad.setObjectName("checkBoxGrad")
        self.formLayout_2.setWidget(
            0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.checkBoxGrad
        )
        self.doubleSpinBoxGradReject = QtWidgets.QDoubleSpinBox(
            parent=self.groupBoxRejection
        )
        ...
        self.formLayout_2.setWidget(
            0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxGradReject
        )
        self.checkBoxMag = QtWidgets.QCheckBox(parent=self.groupBoxRejection)
        self.checkBoxMag.setChecked(True)
        self.checkBoxMag.setObjectName("checkBoxMag")
        self.formLayout_2.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.checkBoxMag
        )
        self.doubleSpinBoxMagReject = QtWidgets.QDoubleSpinBox(
            parent=self.groupBoxRejection
        )
        ...
        self.formLayout_2.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxMagReject
        )
        self.checkBoxEeg = QtWidgets.QCheckBox(parent=self.groupBoxRejection)
        self.checkBoxEeg.setChecked(True)
        self.checkBoxEeg.setObjectName("checkBoxEeg")
        self.formLayout_2.setWidget(
            2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.checkBoxEeg
        )
        self.doubleSpinBoxEEGReject = QtWidgets.QDoubleSpinBox(
            parent=self.groupBoxRejection
        )
        ...
        self.formLayout_2.setWidget(
            2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxEEGReject
        )
        self.gridLayout_7.addWidget(self.groupBoxRejection, 0, 1, 1, 1)
        self.groupBoxEpochs = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        self.groupBoxEpochs.setObjectName("groupBoxEpochs")
        self.formLayout = QtWidgets.QFormLayout(self.groupBoxEpochs)
        self.formLayout.setObjectName("formLayout")
        self.labelCollectionName = QtWidgets.QLabel(parent=self.groupBoxEpochs)
        self.labelCollectionName.setObjectName("labelCollectionName")
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelCollectionName
        )
        self.lineEditCollectionName = QtWidgets.QLineEdit(parent=self.groupBoxEpochs)
        self.lineEditCollectionName.setObjectName("lineEditCollectionName")
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lineEditCollectionName
        )
        self.labelTmin = QtWidgets.QLabel(parent=self.groupBoxEpochs)
        self.labelTmin.setObjectName("labelTmin")
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelTmin
        )
        self.doubleSpinBoxTmin = QtWidgets.QDoubleSpinBox(parent=self.groupBoxEpochs)
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxTmin
        )
        self.labelTmax = QtWidgets.QLabel(parent=self.groupBoxEpochs)
        self.labelTmax.setObjectName("labelTmax")
        self.formLayout.setWidget(
            2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelTmax
        )
        self.doubleSpinBoxTmax = QtWidgets.QDoubleSpinBox(parent=self.groupBoxEpochs)
        ...
        self.formLayout.setWidget(
            2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxTmax
        )
        self.labelBaselineStart = QtWidgets.QLabel(parent=self.groupBoxEpochs)
        self.labelBaselineStart.setObjectName("labelBaselineStart")
        self.formLayout.setWidget(
            3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelBaselineStart
        )
        self.doubleSpinBoxBaselineStart = QtWidgets.QDoubleSpinBox(
            parent=self.groupBoxEpochs
        )
        ...
        self.formLayout.setWidget(
            3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxBaselineStart
        )
        self.labelBaselineEnd = QtWidgets.QLabel(parent=self.groupBoxEpochs)
        self.labelBaselineEnd.setObjectName("labelBaselineEnd")
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelBaselineEnd
        )
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxBaselineEnd
        )
        self.labelDelay = QtWidgets.QLabel(parent=self.groupBoxEpochs)
        self.labelDelay.setObjectName("labelDelay")
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelDelay
        )
        self.doubleSpinBoxDelay = QtWidgets.QDoubleSpinBox(parent=self.groupBoxEpochs)
        ...
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxDelay
        )
        ...
        self.spinBoxEventID = QtWidgets.QSpinBox(parent=self.groupBoxEvent)
        ...
        self.pushButtonEdit = QtWidgets.QPushButton(parent=self.groupBoxEvent)
        self.pushButtonEdit.setObjectName("pushButtonEdit")
        self.gridLayout_2.addWidget(self.pushButtonEdit, 0, 2, 1, 1)
        self.pushButtonHelp = QtWidgets.QPushButton(parent=self.groupBoxEvent)
        self.pushButtonHelp.setObjectName("pushButtonHelp")
        self.gridLayout_2.addWidget(self.pushButtonHelp, 1, 2, 1, 1)
        self.pushButtonAdd = QtWidgets.QPushButton(parent=self.groupBoxEvent)
        self.pushButtonAdd.setObjectName("pushButtonAdd")
        self.gridLayout_2.addWidget(self.pushButtonAdd, 3, 0, 1, 3)
        self.pushButtonClear = QtWidgets.QPushButton(parent=self.groupBoxEvent)
        ...
        self.pushButtonApply.clicked.connect(CreateEpochsFromEventsDialog.accept)  # type: ignore
        self.pushButtonCancel.clicked.connect(CreateEpochsFromEventsDialog.reject)  # type: ignore
        self.checkBoxGrad.toggled["bool"].connect(self.doubleSpinBoxGradReject.setEnabled)  # type: ignore
        self.checkBoxMag.toggled["bool"].connect(self.doubleSpinBoxMagReject.setEnabled)  # type: ignore
        self.checkBoxEeg.toggled["bool"].connect(self.doubleSpinBoxEEGReject.setEnabled)  # type: ignore
        self.pushButtonBatch.clicked.connect(CreateEpochsFromEventsDialog.acceptBatch)  # type: ignore
