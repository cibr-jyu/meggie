...
class Ui_PowerSpectrumAddAdvancedDialog(object):
    def setupUi(self, PowerSpectrumAddAdvancedDialog):
        ...
        PowerSpectrumAddAdvancedDialog.resize(356, 486)
        ...
        self.gridLayout_3.addWidget(self.labelStartOffset, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBoxStartOffset, 4, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBoxEndOffset, 4, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.labelEndOffset, 4, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.radioButtonEndUseEnd, 3, 0, 1, 4)
