...
class Ui_PowerSpectrumDialog(object):
    def setupUi(self, PowerSpectrumDialog):
        ...
        PowerSpectrumDialog.resize(596, 712)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -139, 562, 800))
        self.scrollAreaWidgetContents.setMinimumSize(QtCore.QSize(550, 800))
        ...
        self.gridLayout_2.addWidget(self.pushButtonAddAdvanced, 8, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.pushButtonClearRow, 9, 0, 1, 2)
        self.pushButtonClear = QtWidgets.QPushButton(self.groupBoxIntervals)
        self.pushButtonClear.setObjectName("pushButtonClear")
        self.gridLayout_2.addWidget(self.pushButtonClear, 10, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.listWidgetIntervals, 0, 2, 11, 1)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.checkBoxLogarithm)
        ...
        self.gridLayout_5 = QtWidgets.QGridLayout(self.groupBoxBatching)
        ...
        self.gridLayout_5.addWidget(self.batchingWidgetPlaceholder, 0, 0, 1, 1)
    ...
    def retranslateUi(self, PowerSpectrumDialog):
        ...
        self.pushButtonCompute.setText(_translate("PowerSpectrumDialog", "Apply"))
