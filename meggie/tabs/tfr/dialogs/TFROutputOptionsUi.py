...
class Ui_TFROutputOptions(object):
    def setupUi(self, TFROutputOptions):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(TFROutputOptions)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 514, 547))
        ...
        self.buttonBox.accepted.connect(TFROutputOptions.accept)
        self.buttonBox.rejected.connect(TFROutputOptions.reject)
        ...
        TFROutputOptions.setTabOrder(self.scrollArea, self.buttonBox)
