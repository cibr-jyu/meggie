...
class Ui_CreateEpochsFromEventsDialog(object):
    def setupUi(self, CreateEpochsFromEventsDialog):
        ...
        CreateEpochsFromEventsDialog.setTabOrder(self.pushButtonApply, self.scrollArea)
        CreateEpochsFromEventsDialog.setTabOrder(self.scrollArea, self.lineEditCollectionName)
        ...
        CreateEpochsFromEventsDialog.setTabOrder(self.doubleSpinBoxBaselineEnd, self.checkBoxGrad)
