...
class Ui_CreateEpochsFromEventsDialog(object):
    def setupUi(self, CreateEpochsFromEventsDialog):
        ...
        CreateEpochsFromEventsDialog.resize(776, 783)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 758, 734))
        ...
        self.gridLayout_2.addWidget(self.lineEditMask, 1, 1, 1, 1)
    ...
    def retranslateUi(self, CreateEpochsFromEventsDialog):
        ...
        self.lineEditMask.setText(_translate("CreateEpochsFromEventsDialog", "0"))
