...
class Ui_evokedTopomapDialog(object):
    def setupUi(self, evokedTopomapDialog):
        ...
        self.groupBoxTimes = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
        self.groupBoxTimes.setObjectName("groupBoxTimes")
        self.formLayout = QtWidgets.QFormLayout(self.groupBoxTimes)
        self.formLayout.setObjectName("formLayout")
        self.labelStart = QtWidgets.QLabel(self.groupBoxTimes)
        self.labelStart.setObjectName("labelStart")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.labelStart)
        self.doubleSpinBoxStart = QtWidgets.QDoubleSpinBox(self.groupBoxTimes)
        ...
        self.labelEnd = QtWidgets.QLabel(self.groupBoxTimes)
        self.labelEnd.setObjectName("labelEnd")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.labelEnd)
        self.doubleSpinBoxEnd = QtWidgets.QDoubleSpinBox(self.groupBoxTimes)
        ...
        self.labelStep = QtWidgets.QLabel(self.groupBoxTimes)
        self.labelStep.setObjectName("labelStep")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labelStep)
        self.doubleSpinBoxStep = QtWidgets.QDoubleSpinBox(self.groupBoxTimes)
    ...
    def retranslateUi(self, evokedTopomapDialog):
        ...
        self.groupBoxTimes.setTitle(_translate("evokedTopomapDialog", "Times:"))
