...
class Ui_covarianceEpochDialog(object):
    def setupUi(self, covarianceEpochDialog):
        ...
        covarianceEpochDialog.resize(503, 555)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 483, 498))
        ...
        self.listWidgetEpochs.setGeometry(QtCore.QRect(10, 30, 441, 121))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 30, 441, 110))
        ...
        self.groupBoxProjections = QtGui.QGroupBox(self.scrollAreaWidgetContents)
        ...
        self.listWidgetProjections.setGeometry(QtCore.QRect(10, 30, 441, 121))
        self.listWidgetProjections.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)
        self.listWidgetProjections.setObjectName(_fromUtf8("listWidgetProjections"))
        self.verticalLayout.addWidget(self.groupBoxProjections)
    ...
    def retranslateUi(self, covarianceEpochDialog):
        ...
        self.groupBoxProjections.setTitle(_translate("covarianceEpochDialog", "Projections", None))
