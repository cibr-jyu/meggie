...
# Form implementation generated from reading ui file 'evokedStatsDialogUi.ui'
#
...
class Ui_EvokedStatsDialog(object):
    def setupUi(self, EvokedStatsDialog):
        ...
        self.labelMax = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelMax.setObjectName(_fromUtf8("labelMax"))
        self.gridLayout_2.addWidget(self.labelMax, 5, 1, 1, 1)
        self.labelMaxTimeAfter = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelMaxTimeAfter.setObjectName(_fromUtf8("labelMaxTimeAfter"))
        self.gridLayout_2.addWidget(self.labelMaxTimeAfter, 9, 1, 1, 1)
        self.doubleSpinBoxMinTime = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxMinTime, 4, 2, 1, 1)
        self.labelStart = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelStart.setObjectName(_fromUtf8("labelStart"))
        self.gridLayout_2.addWidget(self.labelStart, 1, 1, 1, 1)
        self.labelMin = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelMin.setObjectName(_fromUtf8("labelMin"))
        self.gridLayout_2.addWidget(self.labelMin, 3, 1, 1, 1)
        self.pushButtonVisualize = QtGui.QPushButton(self.scrollAreaWidgetContents)
        self.pushButtonVisualize.setObjectName(_fromUtf8("pushButtonVisualize"))
        self.gridLayout_2.addWidget(self.pushButtonVisualize, 12, 1, 1, 1)
        self.labelIntegral = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelIntegral.setObjectName(_fromUtf8("labelIntegral"))
        self.gridLayout_2.addWidget(self.labelIntegral, 11, 1, 1, 1)
        self.doubleSpinBoxMinAmplitude = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.doubleSpinBoxMinAmplitude.setMinimum(-99999.0)
        self.doubleSpinBoxMinAmplitude.setMaximum(99999.99)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxMinAmplitude, 3, 2, 1, 1)
        self.labelMaxTime = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelMaxTime.setObjectName(_fromUtf8("labelMaxTime"))
        self.gridLayout_2.addWidget(self.labelMaxTime, 6, 1, 1, 1)
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.groupBoxLobes = QtGui.QGroupBox(self.scrollAreaWidgetContents)
        ...
        self.checkBoxLOcci.raise_()
        self.checkBoxROcci.raise_()
        self.checkBoxLFrontal.raise_()
        self.checkBoxLTemp.raise_()
        self.checkBoxRTemp.raise_()
        self.checkBoxLParietal.raise_()
        self.checkBoxVertex.raise_()
        self.checkBoxRFrontal.raise_()
        self.checkBoxRParietal.raise_()
        ...
        self.radioButtonGrad = QtGui.QRadioButton(self.groupBox)
        self.radioButtonGrad.setChecked(True)
        self.radioButtonGrad.setObjectName(_fromUtf8("radioButtonGrad"))
        self.buttonGroup = QtGui.QButtonGroup(EvokedStatsDialog)
        self.buttonGroup.setObjectName(_fromUtf8("buttonGroup"))
        self.buttonGroup.addButton(self.radioButtonGrad)
        self.verticalLayout_2.addWidget(self.radioButtonGrad)
        self.radioButtonMag = QtGui.QRadioButton(self.groupBox)
        self.radioButtonMag.setObjectName(_fromUtf8("radioButtonMag"))
        self.buttonGroup.addButton(self.radioButtonMag)
        self.verticalLayout_2.addWidget(self.radioButtonMag)
        self.radioButtonEeg = QtGui.QRadioButton(self.groupBox)
        self.radioButtonEeg.setObjectName(_fromUtf8("radioButtonEeg"))
        self.buttonGroup.addButton(self.radioButtonEeg)
        self.verticalLayout_2.addWidget(self.radioButtonEeg)
        self.gridLayout_3.addLayout(self.verticalLayout_2, 0, 0, 1, 1)
        self.horizontalLayout_3.addWidget(self.groupBox)
        spacerItem7 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem7)
        self.gridLayout_2.addLayout(self.horizontalLayout_3, 14, 0, 1, 2)
        self.labelDuration = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelDuration.setObjectName(_fromUtf8("labelDuration"))
        self.gridLayout_2.addWidget(self.labelDuration, 10, 1, 1, 1)
        self.labelSelectedChannel = QtGui.QLabel(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.labelSelectedChannel, 0, 1, 1, 1)
        self.doubleSpinBoxStart = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.doubleSpinBoxStart.setReadOnly(False)
        self.doubleSpinBoxStart.setButtonSymbols(QtGui.QAbstractSpinBox.UpDownArrows)
        self.doubleSpinBoxStart.setDecimals(3)
        self.doubleSpinBoxStart.setMinimum(-99.0)
        self.doubleSpinBoxStart.setSingleStep(0.01)
        self.doubleSpinBoxStart.setObjectName(_fromUtf8("doubleSpinBoxStart"))
        self.gridLayout_2.addWidget(self.doubleSpinBoxStart, 1, 2, 1, 1)
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.pushButtonSetSelected = QtGui.QPushButton(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_4, 13, 0, 1, 2)
        self.doubleSpinBoxIntegral = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.doubleSpinBoxIntegral.setMinimum(-99999.0)
        self.doubleSpinBoxIntegral.setMaximum(99999.99)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxIntegral, 11, 2, 1, 1)
        self.doubleSpinBoxMaxAmplitude = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.doubleSpinBoxMaxAmplitude.setMinimum(-99999.0)
        self.doubleSpinBoxMaxAmplitude.setMaximum(99999.99)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxMaxAmplitude, 5, 2, 1, 1)
        self.doubleSpinBoxHalfMaxAfter = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxHalfMaxAfter, 9, 2, 1, 1)
        self.verticalLayout = QtGui.QVBoxLayout()
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.comboBoxEvoked = QtGui.QComboBox(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addLayout(self.verticalLayout, 0, 0, 13, 1)
        self.doubleSpinBoxDuration = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxDuration, 10, 2, 1, 1)
        self.labelMinTime = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelMinTime.setObjectName(_fromUtf8("labelMinTime"))
        self.gridLayout_2.addWidget(self.labelMinTime, 4, 1, 1, 1)
        self.doubleSpinBoxHalfMaxAmplitude = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.doubleSpinBoxHalfMaxAmplitude.setMinimum(-99999.0)
        self.doubleSpinBoxHalfMaxAmplitude.setMaximum(99999.99)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxHalfMaxAmplitude, 7, 2, 1, 1)
        self.doubleSpinBoxMaxTime = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxMaxTime, 6, 2, 1, 1)
        self.labelStop = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelStop.setObjectName(_fromUtf8("labelStop"))
        self.gridLayout_2.addWidget(self.labelStop, 2, 1, 1, 1)
        self.labelHalfMaxBefore = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelHalfMaxBefore.setObjectName(_fromUtf8("labelHalfMaxBefore"))
        self.gridLayout_2.addWidget(self.labelHalfMaxBefore, 8, 1, 1, 1)
        self.doubleSpinBoxStop = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, brush)
        self.doubleSpinBoxStop.setPalette(palette)
        self.doubleSpinBoxStop.setReadOnly(False)
        self.doubleSpinBoxStop.setButtonSymbols(QtGui.QAbstractSpinBox.UpDownArrows)
        self.doubleSpinBoxStop.setDecimals(3)
        self.doubleSpinBoxStop.setMinimum(-99.0)
        self.doubleSpinBoxStop.setSingleStep(0.01)
        self.doubleSpinBoxStop.setObjectName(_fromUtf8("doubleSpinBoxStop"))
        self.gridLayout_2.addWidget(self.doubleSpinBoxStop, 2, 2, 1, 1)
        self.labelHalfMax = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.labelHalfMax.setObjectName(_fromUtf8("labelHalfMax"))
        self.gridLayout_2.addWidget(self.labelHalfMax, 7, 1, 1, 1)
        self.doubleSpinBoxHalfMaxBefore = QtGui.QDoubleSpinBox(self.scrollAreaWidgetContents)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBoxHalfMaxBefore, 8, 2, 1, 1)
        ...
        EvokedStatsDialog.setTabOrder(self.doubleSpinBoxStart, self.doubleSpinBoxIntegral)
    ...
    def retranslateUi(self, EvokedStatsDialog):
        ...
        self.doubleSpinBoxMinAmplitude.setSuffix(_translate("EvokedStatsDialog", "fT", None))
...
"MEG 2211", None))
        ...
        self.groupBox.setTitle(_translate("EvokedStatsDialog", "Include", None))
        self.radioButtonGrad.setText(_translate("EvokedStatsDialog", "Grad", None))
        self.radioButtonMag.setText(_translate("EvokedStatsDialog", "Mag", None))
        self.radioButtonEeg.setText(_translate("EvokedStatsDialog", "EEG", None))
        ...
        self.doubleSpinBoxMaxAmplitude.setSuffix(_translate("EvokedStatsDialog", "fT", None))
        ...
        self.doubleSpinBoxHalfMaxAmplitude.setSuffix(_translate("EvokedStatsDialog", "fT", None))
