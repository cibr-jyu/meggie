...
class Ui_LogDialog(object):
    def setupUi(self, LogDialog):
        ...
        self.verticalLayoutWidget = QtGui.QWidget(LogDialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(30, 21, 1031, 671))
        ...
        self.pushButtonClose = QtGui.QPushButton(self.verticalLayoutWidget)
