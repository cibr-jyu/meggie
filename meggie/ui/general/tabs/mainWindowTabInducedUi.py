...
class Ui_mainWindowTabInduced(object):
    def setupUi(self, mainWindowTabInduced):
        ...
        self.pushButtonPlotTFRTopology = QtGui.QPushButton(self.groupBox_2)
        self.pushButtonPlotTFRTopology.setObjectName(_fromUtf8("pushButtonPlotTFRTopology"))
        self.horizontalLayout_2.addWidget(self.pushButtonPlotTFRTopology)
        ...
        self.pushButtonSaveTFR.setEnabled(False)
        ...
        self.pushButtonGroupSaveTFR.setEnabled(False)
    ...
    def retranslateUi(self, mainWindowTabInduced):
        ...
        self.pushButtonPlotTFRTopology.setText(_translate("mainWindowTabInduced", "Plot TFR topology", None))
