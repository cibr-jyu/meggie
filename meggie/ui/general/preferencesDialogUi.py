...
class Ui_DialogPreferences(object):
    def setupUi(self, DialogPreferences):
        ...
        self.checkBoxPlotClose = QtGui.QCheckBox(self.groupBox)
        self.checkBoxPlotClose.setObjectName(_fromUtf8("checkBoxPlotClose"))
        self.gridLayout_4.addWidget(self.checkBoxPlotClose, 2, 0, 1, 1)
    ...
    def retranslateUi(self, DialogPreferences):
        ...
        self.checkBoxPlotClose.setText(_translate("DialogPreferences", "Save bads on plot close", None))
