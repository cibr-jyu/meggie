...
class Ui_DialogGroupTFR(object):
    def setupUi(self, DialogGroupTFR):
        ...
        self.verticalLayout_2.addWidget(self.checkBoxSavePlot)
        self.checkBoxSaveMaxima = QtGui.QCheckBox(self.groupBox)
        self.checkBoxSaveMaxima.setObjectName(_fromUtf8("checkBoxSaveMaxima"))
        self.verticalLayout_2.addWidget(self.checkBoxSaveMaxima)
        ...
        DialogGroupTFR.setTabOrder(self.checkBoxSaveTopo, self.groupBox)
        DialogGroupTFR.setTabOrder(self.groupBox, self.listWidgetChannels)
        DialogGroupTFR.setTabOrder(self.listWidgetChannels, self.pushButtonModify)
        DialogGroupTFR.setTabOrder(self.pushButtonModify, self.checkBoxSavePlot)
        DialogGroupTFR.setTabOrder(self.checkBoxSavePlot, self.checkBoxSaveMaxima)
        DialogGroupTFR.setTabOrder(self.checkBoxSaveMaxima, self.buttonBox)
    ...
    def retranslateUi(self, DialogGroupTFR):
        ...
        self.checkBoxSavePlot.setToolTip(_translate("DialogGroupTFR", "If checked, the plot figures are saved as a file.", None))
        self.checkBoxSavePlot.setText(_translate("DialogGroupTFR", "Save plot figures for individual channels.", None))
        self.checkBoxSaveMaxima.setToolTip(_translate("DialogGroupTFR", "If checked, the location of maximum values from each subject are written to a file.", None))
        self.checkBoxSaveMaxima.setText(_translate("DialogGroupTFR", "Write maxima to a text file.", None))
