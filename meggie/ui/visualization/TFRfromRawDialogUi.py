...
class Ui_DialogRawTFR(object):
    def setupUi(self, DialogRawTFR):
        ...
        self.checkBoxFrequency = QtGui.QCheckBox(DialogRawTFR)
        self.checkBoxFrequency.setObjectName(_fromUtf8("checkBoxFrequency"))
        self.verticalLayout.addWidget(self.checkBoxFrequency)
        ...
        self.spinBoxFmin.setEnabled(False)
        ...
        self.spinBoxFmax.setEnabled(False)
        ...
        self.radioButtonSelectLayout = QtGui.QRadioButton(DialogRawTFR)
        ...
        self.comboBoxLayout = QtGui.QComboBox(DialogRawTFR)
        ...
        self.radioButtonLayoutFromFile = QtGui.QRadioButton(DialogRawTFR)
        ...
        self.pushButtonBrowseLayout = QtGui.QPushButton(DialogRawTFR)
        ...
        QtCore.QObject.connect(self.checkBoxFrequency, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.spinBoxFmin.setEnabled)
        QtCore.QObject.connect(self.checkBoxFrequency, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.spinBoxFmax.setEnabled)
    ...
    def retranslateUi(self, DialogRawTFR):
        ...
        self.checkBoxFrequency.setText(_translate("DialogRawTFR", "Limit frequencies", None))
        ...
        self.radioButtonSelectLayout.setText(_translate("DialogRawTFR", "Select layout", None))
        self.comboBoxLayout.setItemText(0, _translate("DialogRawTFR", "Infer from data", None))
        self.radioButtonLayoutFromFile.setText(_translate("DialogRawTFR", "Layout from file", None))
        self.pushButtonBrowseLayout.setText(_translate("DialogRawTFR", "Browse...", None))
