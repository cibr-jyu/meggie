...
class Ui_DialogEpochsTFR(object):
    def setupUi(self, DialogEpochsTFR):
        ...
        self.spinBoxDecim_2 = QtGui.QSpinBox(self.groupBoxMisc)
        self.spinBoxDecim_2.setProperty("value", 2)
        self.spinBoxDecim_2.setObjectName(_fromUtf8("spinBoxDecim_2"))
        self.gridLayout_10.addWidget(self.spinBoxDecim_2, 1, 1, 1, 1)
        self.labelCmap_2 = QtGui.QLabel(self.groupBoxMisc)
        self.labelCmap_2.setObjectName(_fromUtf8("labelCmap_2"))
        self.gridLayout_10.addWidget(self.labelCmap_2, 0, 0, 1, 1)
        self.comboBoxCmap_2 = QtGui.QComboBox(self.groupBoxMisc)
        self.comboBoxCmap_2.setObjectName(_fromUtf8("comboBoxCmap_2"))
        self.comboBoxCmap_2.addItem(_fromUtf8(""))
        self.comboBoxCmap_2.addItem(_fromUtf8(""))
        self.comboBoxCmap_2.addItem(_fromUtf8(""))
        self.comboBoxCmap_2.addItem(_fromUtf8(""))
        self.comboBoxCmap_2.addItem(_fromUtf8(""))
        self.comboBoxCmap_2.addItem(_fromUtf8(""))
        self.gridLayout_10.addWidget(self.comboBoxCmap_2, 0, 1, 1, 1)
        self.label_3 = QtGui.QLabel(self.groupBoxMisc)
        ...
        self.comboBoxCmap_2.setCurrentIndex(0)
    ...
    def retranslateUi(self, DialogEpochsTFR):
        ...
        self.labelCmap_2.setText(_translate("DialogEpochsTFR", "Color map:", None))
        self.comboBoxCmap_2.setItemText(0, _translate("DialogEpochsTFR", "auto", None))
        self.comboBoxCmap_2.setItemText(1, _translate("DialogEpochsTFR", "RdBu_r", None))
        self.comboBoxCmap_2.setItemText(2, _translate("DialogEpochsTFR", "Reds", None))
        self.comboBoxCmap_2.setItemText(3, _translate("DialogEpochsTFR", "YlOrRd", None))
        self.comboBoxCmap_2.setItemText(4, _translate("DialogEpochsTFR", "seismic", None))
        self.comboBoxCmap_2.setItemText(5, _translate("DialogEpochsTFR", "bwr", None))
        self.label_3.setText(_translate("DialogEpochsTFR", "Decimation factor:", None))
