...
class Ui_DialogTFRTopology(object):
    def setupUi(self, DialogTFRTopology):
        ...
        DialogTFRTopology.setTabOrder(self.radioButtonSelectLayout, self.radioButtonLayoutFromFile)
        DialogTFRTopology.setTabOrder(self.radioButtonLayoutFromFile, self.comboBoxLayout)
        DialogTFRTopology.setTabOrder(self.comboBoxLayout, self.pushButtonBrowseLayout)
