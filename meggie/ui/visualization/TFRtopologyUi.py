...
class Ui_DialogTFRTopology(object):
    ...
    def retranslateUi(self, DialogTFRTopology):
        ...
        self.comboBoxCmap.setItemText(0, _translate("DialogTFRTopology", "RdBu_r", None))
        self.comboBoxCmap.setItemText(1, _translate("DialogTFRTopology", "Reds", None))
        self.comboBoxCmap.setItemText(2, _translate("DialogTFRTopology", "YlOrRd", None))
        self.comboBoxCmap.setItemText(3, _translate("DialogTFRTopology", "seismic", None))
        self.comboBoxCmap.setItemText(4, _translate("DialogTFRTopology", "bwr", None))
