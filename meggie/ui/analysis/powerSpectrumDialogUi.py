...
class Ui_PowerSpectrumDialog(object):
    def setupUi(self, PowerSpectrumDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 704, 597))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 549, 671, 41))
        self.horizontalLayoutWidget.setObjectName(_fromUtf8("horizontalLayoutWidget"))
        self.horizontalLayout_7 = QtGui.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.checkBoxSaveData = QtGui.QCheckBox(self.horizontalLayoutWidget)
        self.checkBoxSaveData.setObjectName(_fromUtf8("checkBoxSaveData"))
        self.horizontalLayout_7.addWidget(self.checkBoxSaveData)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem)
        self.pushButtonOutputOptions = QtGui.QPushButton(self.horizontalLayoutWidget)
        self.pushButtonOutputOptions.setObjectName(_fromUtf8("pushButtonOutputOptions"))
        self.horizontalLayout_7.addWidget(self.pushButtonOutputOptions)
    ...
    def retranslateUi(self, PowerSpectrumDialog):
        ...
        self.pushButtonOutputOptions.setText(_translate("PowerSpectrumDialog", "Output options...", None))
