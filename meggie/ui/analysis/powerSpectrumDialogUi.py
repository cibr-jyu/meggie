...
class Ui_PowerSpectrumDialog(object):
    def setupUi(self, PowerSpectrumDialog):
        ...
        PowerSpectrumDialog.resize(741, 852)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 707, 1050))
        self.scrollAreaWidgetContents.setMinimumSize(QtCore.QSize(700, 1050))
        ...
        self.widgetBatchContainer.setGeometry(QtCore.QRect(20, 610, 120, 80))
        ...
        self.pushButtonComputeBatch = QtWidgets.QPushButton(PowerSpectrumDialog)
        ...
        self.pushButtonCompute = QtWidgets.QPushButton(PowerSpectrumDialog)
        ...
        self.pushButtonCompute.clicked.connect(PowerSpectrumDialog.accept)
        self.pushButtonReject.clicked.connect(PowerSpectrumDialog.reject)
        self.pushButtonComputeBatch.clicked.connect(PowerSpectrumDialog.acceptBatch)
    ...
    def retranslateUi(self, PowerSpectrumDialog):
        ...
        self.pushButtonComputeBatch.setText(_translate("PowerSpectrumDialog", "Batch"))
        self.pushButtonCompute.setText(_translate("PowerSpectrumDialog", "Compute"))
