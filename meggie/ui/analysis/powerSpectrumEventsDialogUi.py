...
class Ui_Advanced(object):
    def setupUi(self, Advanced):
        ...
        self.pushButtonMaskStart = QtGui.QPushButton(Advanced)
        self.pushButtonMaskStart.setObjectName(_fromUtf8("pushButtonMaskStart"))
        self.gridLayout.addWidget(self.pushButtonMaskStart, 1, 2, 1, 1)
        self.pushButtonMaskEnd = QtGui.QPushButton(Advanced)
        self.pushButtonMaskEnd.setObjectName(_fromUtf8("pushButtonMaskEnd"))
    ...
    def retranslateUi(self, Advanced):
        ...
        self.pushButtonMaskStart.setText(_translate("Advanced", "Edit...", None))
        self.pushButtonMaskEnd.setText(_translate("Advanced", "Edit...", None))
