...
class Ui_EventSelectionDialog(object):
    def setupUi(self, EventSelectionDialog):
        ...
        EventSelectionDialog.resize(759, 941)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 741, 884))
        ...
        self.widget.setGeometry(QtCore.QRect(30, 430, 311, 441))
