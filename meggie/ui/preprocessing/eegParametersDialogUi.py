...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 600, 623))
        ...
        self.verticalLayoutWidget_3 = QtGui.QWidget(self.scrollAreaWidgetContents)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 530, 221, 80))
        self.verticalLayoutWidget_3.setObjectName(_fromUtf8("verticalLayoutWidget_3"))
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.pushButtonPlotEpochs = QtGui.QPushButton(self.verticalLayoutWidget_3)
        self.pushButtonPlotEpochs.setObjectName(_fromUtf8("pushButtonPlotEpochs"))
        self.verticalLayout_4.addWidget(self.pushButtonPlotEpochs)
        self.pushButtonShowEvents = QtGui.QPushButton(self.verticalLayoutWidget_3)
        self.pushButtonShowEvents.setObjectName(_fromUtf8("pushButtonShowEvents"))
        self.verticalLayout_4.addWidget(self.pushButtonShowEvents)
