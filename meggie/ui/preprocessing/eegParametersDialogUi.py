...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 603, 574))
        ...
        self.groupBoxProjection.setGeometry(QtCore.QRect(0, 370, 451, 161))
        self.groupBoxProjection.setObjectName(_fromUtf8("groupBoxProjection"))
        self.verticalLayoutWidget_2 = QtGui.QWidget(self.groupBoxProjection)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 431, 119))
        self.verticalLayoutWidget_2.setObjectName(_fromUtf8("verticalLayoutWidget_2"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.labelTmin = QtGui.QLabel(self.verticalLayoutWidget_2)
        self.labelTmin.setObjectName(_fromUtf8("labelTmin"))
        self.horizontalLayout_2.addWidget(self.labelTmin)
        self.doubleSpinBoxTmin = QtGui.QDoubleSpinBox(self.verticalLayoutWidget_2)
        ...
        self.labelTmax = QtGui.QLabel(self.verticalLayoutWidget_2)
        self.labelTmax.setObjectName(_fromUtf8("labelTmax"))
        self.horizontalLayout_3.addWidget(self.labelTmax)
        self.doubleSpinBoxTmax = QtGui.QDoubleSpinBox(self.verticalLayoutWidget_2)
        ...
        self.labelVectors = QtGui.QLabel(self.verticalLayoutWidget_2)
        self.labelVectors.setObjectName(_fromUtf8("labelVectors"))
        self.horizontalLayout.addWidget(self.labelVectors)
        self.spinBoxVectors = QtGui.QSpinBox(self.verticalLayoutWidget_2)
        ...
        self.horizontalLayout.addWidget(self.spinBoxVectors)
        ...
        self.pushButtonAddProjs = QtGui.QPushButton(Dialog)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonAddProjs.sizePolicy().hasHeightForWidth())
        self.pushButtonAddProjs.setSizePolicy(sizePolicy)
        self.pushButtonAddProjs.setObjectName(_fromUtf8("pushButtonAddProjs"))
        self.horizontalLayout_19.addWidget(self.pushButtonAddProjs)
        ...
        QtCore.QObject.connect(self.pushButtonAddProjs, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog.accept)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButtonAddProjs.setText(_translate("Dialog", "Add SSP projections", None))
